...
public class dataCollector {
    ...
    String avgFilename = "src/main/resources/csvFiles/sampleAverage.csv";
    String ShoppingListFilename = "src/main/resources/csvFiles/shoppingList.csv";
    String Date;
    ...
    public String[] getReccomendations(){
        ...
        for(List<String> line: data){
            int timeDiff =0;
            if(line.get(2).equals("/0")){
                timeDiff = timeDiff(line.get(1), Date);
            }
            else{
